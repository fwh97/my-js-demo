...
/*for(var key in Drag.prototype){   //for in 继承原型方法；  拷贝继承，
	Textmenu.prototype[key]=Drag.prototype[key];    //把一个对象中的属性或者方法直接复制到另一个对象中
}
console.log(Drag.prototype.moveBump===Textmenu.prototype.moveBump);
 */
Textmenu.prototype=new Drag("Textmenu");  //搞了半天 原来是没加载这个元素进来
